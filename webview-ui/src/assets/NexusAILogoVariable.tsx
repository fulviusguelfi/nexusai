...
/**
 * NexusAILogoVariable component renders the Cline logo with automatic theme adaptation
 ...
 */
const NexusAILogoVariable = (props: SVGProps<SVGSVGElement> & { environment?: Environment }) => {
...
export default NexusAILogoVariable
