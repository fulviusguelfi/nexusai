...
export function useScrollBehavior(
	...
	visibleMessages: NexusAIMessage[],
	...
	const [scrolledPastUserMessage, setScrolledPastUserMessage] = useState<NexusAIMessage | null>(null)
	...
	const checkScrolledPastUserMessage = useCallback(() => {
		...
		let mostRecentScrolledPast: NexusAIMessage | null = null
