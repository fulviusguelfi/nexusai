			...
			<Section>
				...
				<div className="mb-[5px]">
					...
					<p className="text-sm mt-[5px] text-description">
						Help improve NexusAI by sending usage data and error reports. No code, prompts, or personal information
						are ever sent. See our telemetry overview and privacy policy for more details.
					</p>
				</div>
			</Section>
		</div>
