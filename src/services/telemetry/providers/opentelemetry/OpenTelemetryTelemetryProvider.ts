...
export class OpenTelemetryTelemetryProvider implements ITelemetryProvider {
	...
	public identifyUser(userInfo: NexusAIAccountUserInfo, properties: TelemetryProperties = {}): void {
	 ...
	 */
	private buildUserAttributes(userInfo: NexusAIAccountUserInfo, properties: TelemetryProperties = {}): Record<string, string> {
