/**
 * NexusAITempManager - Manages temporary files for Cline with automatic cleanup.
 *
 * Simple approach:
...
export const NexusAITempManager = new NexusAITempManagerImpl()
