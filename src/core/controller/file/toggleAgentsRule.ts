import type { ToggleAgentsRuleRequest } from "@shared/proto/nexusai/file"
 ...
 */
export async function toggleAgentsRule(controller: Controller, request: ToggleAgentsRuleRequest): Promise<NexusAIRulesToggles> {
