import { NexusAIRulesToggles, RuleScope, ToggleWorkflowRequest } from "@shared/proto/nexusai/file"
 ...
 */
export async function toggleWorkflow(controller: Controller, request: ToggleWorkflowRequest): Promise<NexusAIRulesToggles> {
	...
	return NexusAIRulesToggles.create({ toggles: toggles })
}
