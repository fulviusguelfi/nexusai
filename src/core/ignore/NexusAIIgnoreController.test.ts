...
import { NexusAIIgnoreController } from "./NexusAIIgnoreController"
import "should"

describe("NexusAIIgnoreController", () => {
	let tempDir: string
	let controller: NexusAIIgnoreController
	...
	beforeEach(async () => {
		...
		controller = new NexusAIIgnoreController(tempDir)
	...
	describe("Error Handling", () => {
		...
		it("should handle missing .clineignore gracefully", async () => {
			...
			try {
				const controller = new NexusAIIgnoreController(emptyDir)
				await controller.initialize()
