...
export const fileRouter = router({
	copyToClipboard: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => copyToClipboard(ctx.controller, input as any)),
	...
	toggleClineRule: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => toggleClineRule(ctx.controller, input as any)),
	toggleCursorRule: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => toggleCursorRule(ctx.controller, input as any)),
	toggleWindsurfRule: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => toggleWindsurfRule(ctx.controller, input as any)),
	toggleAgentsRule: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => toggleAgentsRule(ctx.controller, input as any)),
	refreshRules: publicProcedure.input(e).mutation(({ ctx, input }) => refreshRules(ctx.controller, input)),
	openDiskConversationHistory: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => openDiskConversationHistory(ctx.controller, input as any)),
	toggleWorkflow: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => toggleWorkflow(ctx.controller, input as any)),
	ifFileExistsRelativePath: publicProcedure.input(z.custom()).query(({ ctx, input }) => ifFileExistsRelativePath(ctx.controller, input as any)),
	openFileRelativePath: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => openFileRelativePath(ctx.controller, input as any)),
	openFocusChainFile: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => openFocusChainFile(ctx.controller, input as any)),
	...
	createSkillFile: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => createSkillFile(ctx.controller, input as any)),
	deleteSkillFile: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => deleteSkillFile(ctx.controller, input as any)),
})
