...
export const taskRouter = router({
	...
	cancelBackgroundCommand: publicProcedure
		.input(e)
		.mutation(({ ctx, input }) => cancelBackgroundCommand(ctx.controller, input)),
	...
	deleteTasksWithIds: publicProcedure
		.input(z.custom())
		.mutation(({ ctx, input }) => deleteTasksWithIds(ctx.controller, input as any)),
	...
	exportTaskWithId: publicProcedure
		.input(z.custom())
		.mutation(({ ctx, input }) => exportTaskWithId(ctx.controller, input as any)),
	toggleTaskFavorite: publicProcedure
		.input(z.custom())
		.mutation(({ ctx, input }) => toggleTaskFavorite(ctx.controller, input as any)),
	...
	taskCompletionViewChanges: publicProcedure
		.input(z.custom())
		.mutation(({ ctx, input }) => taskCompletionViewChanges(ctx.controller, input as any)),
	executeQuickWin: publicProcedure
		.input(z.custom())
		.mutation(({ ctx, input }) => executeQuickWin(ctx.controller, input as any)),
