...
export const mcpRouter = router({
	toggleMcpServer: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => toggleMcpServer(ctx.controller, input as any)),
	updateMcpTimeout: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => updateMcpTimeout(ctx.controller, input as any)),
	addRemoteMcpServer: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => addRemoteMcpServer(ctx.controller, input as any)),
	downloadMcp: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => downloadMcp(ctx.controller, input as any)),
	restartMcpServer: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => restartMcpServer(ctx.controller, input as any)),
	deleteMcpServer: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => deleteMcpServer(ctx.controller, input as any)),
	toggleToolAutoApprove: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => toggleToolAutoApprove(ctx.controller, input as any)),
	...
	authenticateMcpServer: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => authenticateMcpServer(ctx.controller, input as any)),
