...
export const stateRouter = router({
	...
	updateTerminalConnectionTimeout: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => updateTerminalConnectionTimeout(ctx.controller, input as any)),
	updateTerminalReuseEnabled: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => updateTerminalReuseEnabled(ctx.controller, input as any)),
	getAvailableTerminalProfiles: publicProcedure.input(e).query(({ ctx, input }) => getAvailableTerminalProfiles(ctx.controller, input)),
	toggleFavoriteModel: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => toggleFavoriteModel(ctx.controller, input as any)),
	resetState: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => resetState(ctx.controller, input as any)),
	togglePlanActModeProto: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => togglePlanActModeProto(ctx.controller, input as any)),
	updateAutoApprovalSettings: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => updateAutoApprovalSettings(ctx.controller, input as any)),
	updateSettings: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => updateSettings(ctx.controller, input as any)),
	updateSettingsCli: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => updateSettingsCli(ctx.controller, input as any)),
	updateTaskSettings: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => updateTaskSettings(ctx.controller, input as any)),
	updateTelemetrySetting: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => updateTelemetrySetting(ctx.controller, input as any)),
	captureOnboardingProgress: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => captureOnboardingProgress(ctx.controller, input as any)),
	setWelcomeViewCompleted: publicProcedure.input(z.custom()).mutation(({ ctx, input }) => setWelcomeViewCompleted(ctx.controller, input as any)),
