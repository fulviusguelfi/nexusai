...
export const uiRouter = router({
	scrollToSettings: publicProcedure
		.input(z.custom())
		.mutation(({ ctx, input }) => scrollToSettings(ctx.controller, input as any)),
	setTerminalExecutionMode: publicProcedure
		.input(z.custom())
		.mutation(({ ctx, input }) => setTerminalExecutionMode(ctx.controller, input as any)),
