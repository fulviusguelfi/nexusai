...
export const modelsRouter = router({
	...
	getLmStudioModels: publicProcedure
		.input(z.custom())
		.query(({ ctx, input }) => getLmStudioModels(ctx.controller, input as any)),
	getVsCodeLmModels: publicProcedure.input(e).query(({ ctx, input }) => getVsCodeLmModels(ctx.controller, input)),
	refreshOpenRouterModelsRpc: publicProcedure
		.input(e)
		.mutation(({ ctx, input }) => refreshOpenRouterModelsRpc(ctx.controller, input)),
	refreshClineRecommendedModelsRpc: publicProcedure
		.input(e)
		.mutation(({ ctx, input }) => refreshClineRecommendedModelsRpc(ctx.controller, input)),
	refreshClineModelsRpc: publicProcedure.input(e).mutation(({ ctx, input }) => refreshClineModelsRpc(ctx.controller, input)),
	refreshHuggingFaceModels: publicProcedure
		.input(e)
		.mutation(({ ctx, input }) => refreshHuggingFaceModels(ctx.controller, input)),
	refreshOpenAiModels: publicProcedure
		.input(z.custom())
		.mutation(({ ctx, input }) => refreshOpenAiModels(ctx.controller, input as any)),
	...
	refreshLiteLlmModelsRpc: publicProcedure
		.input(e)
		.mutation(({ ctx, input }) => refreshLiteLlmModelsRpc(ctx.controller, input)),
	updateApiConfigurationProto: publicProcedure
		.input(z.custom())
		.mutation(({ ctx, input }) => updateApiConfigurationProto(ctx.controller, input as any)),
	updateApiConfiguration: publicProcedure
		.input(z.custom())
		.mutation(({ ctx, input }) => updateApiConfiguration(ctx.controller, input as any)),
	updateApiConfigurationPartial: publicProcedure
		.input(z.custom())
		.mutation(({ ctx, input }) => updateApiConfigurationPartial(ctx.controller, input as any)),
	refreshGroqModelsRpc: publicProcedure.input(e).mutation(({ ctx, input }) => refreshGroqModelsRpc(ctx.controller, input)),
	refreshBasetenModelsRpc: publicProcedure
		.input(e)
		.mutation(({ ctx, input }) => refreshBasetenModelsRpc(ctx.controller, input)),
	getSapAiCoreModels: publicProcedure
		.input(z.custom())
		.query(({ ctx, input }) => getSapAiCoreModels(ctx.controller, input as any)),
	refreshOcaModels: publicProcedure
		.input(z.custom())
		.mutation(({ ctx, input }) => refreshOcaModels(ctx.controller, input as any)),
	getAihubmixModels: publicProcedure.input(e).query(({ ctx, input }) => getAihubmixModels(ctx.controller, input)),
	refreshVercelAiGatewayModelsRpc: publicProcedure
		.input(e)
		.mutation(({ ctx, input }) => refreshVercelAiGatewayModelsRpc(ctx.controller, input)),
