...
export const browserRouter = router({
	...
	testBrowserConnection: publicProcedure
		.input(z.custom())
		.mutation(({ ctx, input }) => testBrowserConnection(ctx.controller, input as any)),
	...
	relaunchChromeDebugMode: publicProcedure
		.input(e)
		.mutation(({ ctx, input }) => relaunchChromeDebugMode(ctx.controller, input)),
})
