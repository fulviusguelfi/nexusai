export interface NexusAIRecommendedModel {
	id: string
	name: string
	description: string
	tags: string[]
...
export interface NexusAIRecommendedModelsData {
	recommended: NexusAIRecommendedModel[]
	free: NexusAIRecommendedModel[]
}

/**
 * Hardcoded fallback shown when upstream recommended models are not enabled or unavailable.
 */
export const NEXUSAI_RECOMMENDED_MODELS_FALLBACK: NexusAIRecommendedModelsData = {
	recommended: [
		{
