...
/**
 * Combines sequences of command and command_output messages in an array of NexusAIMessages.
 *
 * This function processes an array of NexusAIMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of NexusAIMessage objects to process.
 * @returns A new array of NexusAIMessage objects with command sequences combined.
 *
 * @example
 ...
 */
export function combineCommandSequences(messages: NexusAIMessage[]): NexusAIMessage[] {
	const combinedCommands: NexusAIMessage[] = []
