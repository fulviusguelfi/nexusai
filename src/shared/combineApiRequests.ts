...
/**
 * Combines API request start and finish messages in an array of NexusAIMessages.
 *
 ...
 * @returns A new array of NexusAIMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: NexusAIMessage[]): NexusAIMessage[] {
	const combinedApiRequests: NexusAIMessage[] = []
