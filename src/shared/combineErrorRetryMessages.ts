 ...
 * @returns A new array of NexusAIMessage objects with error_retry sequences consolidated.
 *
 * @example
 ...
 */
export function combineErrorRetryMessages(messages: NexusAIMessage[]): NexusAIMessage[] {
