...
import { NexusAISyncStorage } from "./NexusAIStorage"

export interface NexusAIFileStorageOptions {
	/**
 ...
 */
export class NexusAIFileStorage<T = any> extends NexusAISyncStorage<T> {
	protected name: string
	private data: Record<string, T>
	private readonly fsPath: string
	private readonly fileMode?: number

	constructor(filePath: string, name = "NexusAIFileStorage", options?: NexusAIFileStorageOptions) {
		super()
