...
/**
 * Calculates API metrics from an array of NexusAIMessages.
 *
 ...
 */
export function getApiMetrics(messages: NexusAIMessage[]): ApiMetrics {
 ...
 */
export function getLastApiReqTotalTokens(messages: NexusAIMessage[]): number {
